...
import LogoFolioPP from "@/public/images/logo-foliopp.png";
import LogoYF from "@/public/images/yahoo-finance_BIG.png";
import LogoCG from "@/public/images/CG_logo.png";
import LogoBinance from "@/public/images/binance_image.png";
          ...
          <div className="relative flex h-[324px] items-center justify-center">
            ...
            <div className="relative flex flex-col">
              <article className="flex h-full w-full items-center justify-center focus-visible:outline-hidden focus-visible:ring-3 focus-visible:ring-indigo-300">
                ...
                {/* 2. Right Inner - Empty Placeholder */}
                <div className="absolute translate-x-[136px]">
                ...
                {/* 5. Right Bottom - Empty Placeholder */}
                <div className="absolute translate-x-[216px] translate-y-[82px]">
                ...
                {/* 7. Far Left - Black Logo */}
                <div className="absolute -translate-x-[292px] opacity-100">
                  <div className="animate-[breath_6s_ease-in-out_2s_infinite_both]">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full border border-gray-200/60 bg-white shadow-lg overflow-hidden">
                      <Image
                        className="relative"
                        src={LogoBlack}
                        width={24}
