        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              The Reasoning Engine for Multi-Modal Data
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Real-time scanning of NSE filings, bulk deals, and corporate actions to find what others miss.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Automated pattern detection on price charts with historical probability data on every setup.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Enterprise-grade reasoning clusters that process millions of points without synthesis decay.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>High-Fidelity Context</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Every market move is cross-referenced with sectoral narratives, preventing binary choice errors.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Sectoral Cross-Play</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                 Identify cross-vector relationships and hidden pattern clusters that manual cross-referencing fails to detect.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Systematic Bias Guard</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Replace volatile human emotion with machine-coded logic and systematic risk parameters for stable execution.
              </p>
            </article>
          </div>
        </div>
